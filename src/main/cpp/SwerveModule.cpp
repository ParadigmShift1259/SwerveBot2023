...
void SwerveModule::SetDesiredState(const frc::SwerveModuleState& referenceState) {
  ...
  frc::SmartDashboard::PutNumber("Turn Encoder Position" + m_id, currPosition);
  frc::SmartDashboard::PutNumber("Turn Motor Position" + m_id, currPosition / kTurnMotorRevsPerWheelRev);
